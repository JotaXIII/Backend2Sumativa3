...
public class CarritoController {
    ...
    @GetMapping
    @Operation(summary = "Lista los productos del carrito")
    @ApiResponses(value = {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Obtiene un item del carrito por ID")
    @ApiResponses(value = {
    ...
    public ResponseEntity<EntityModel<CarritoResponse>> obtenerCarritoPorId(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Actualiza un item del carrito")
    @ApiResponses(value = {
