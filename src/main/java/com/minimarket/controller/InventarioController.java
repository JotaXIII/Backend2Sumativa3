...
public class InventarioController {
    ...
    @GetMapping
    @Operation(summary = "Lista los movimientos de inventario")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Lista movimientos de inventario por producto")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Movimientos obtenidos correctamente"),
            @ApiResponse(responseCode = "401", description = "No autorizado")
    })
    public CollectionModel<EntityModel<InventarioResponse>> listarMovimientosPorProducto(@PathVariable Long productoId) {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Obtiene un movimiento de inventario por ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Movimiento obtenido correctamente"),
            @ApiResponse(responseCode = "401", description = "No autorizado"),
            @ApiResponse(responseCode = "404", description = "Movimiento no encontrado")
    })
    public ResponseEntity<EntityModel<InventarioResponse>> obtenerMovimientoPorId(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Actualiza un movimiento de inventario")
    @ApiResponses(value = {
    ...
    public ResponseEntity<InventarioResponse> actualizarMovimiento(@PathVariable Long id, @Valid @RequestBody InventarioRequest request) {
